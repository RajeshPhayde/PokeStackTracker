...
const Login = () => {
    ...
    let login = (e) => {
        ...
        if ((user.email == email.current.value || user.phone == email.current.value) && user.password == pwd.current.value) {
    ...
    return (
        <section>
            <div className="account">
                ...
                <form onSubmit={login}>
                    <input id="inp" type="text" placeholder="Enter Email / Phone" required ref={email} />
